...
public class OpinionControllerTest {
    ...
    public void addAndGetOpinions(){
        ...
        ResponseEntity<Integer> response4= restTemplate.postForEntity("/opinion/" + id + "/" + bean.id + "/increment",
                null,
                Integer.class);
        Assert.assertEquals(new Integer(1), response4.getBody());
        ResponseEntity<Integer> response5= restTemplate.postForEntity("/opinion/" + id + "/" + bean.id + "/decrement",
                null,
                Integer.class);
